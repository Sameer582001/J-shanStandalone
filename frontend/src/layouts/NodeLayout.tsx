...
import { LayoutDashboard, Network, DollarSign, ArrowLeft } from 'lucide-react';
...
const NodeLayout: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex">
            {/* Sidebar */}
            <aside className="w-64 bg-gray-900 shadow-xl hidden md:block z-10 text-white">
                ...
                <nav className="mt-6 px-4 space-y-2">
                    <Link
                        to="/node/dashboard"
                        className="flex items-center px-4 py-3 text-gray-300 hover:bg-gray-800 hover:text-white rounded-xl transition-all font-medium"
                    >
            ...
            <div className="flex-1 flex flex-col">
                ...
                <header className="bg-white shadow-sm h-16 flex items-center justify-between px-8 border-b border-gray-100">
                    <div className="md:hidden">
                        <h1 className="text-xl font-bold text-gray-900">Node View</h1>
                    </div>
                    <div className="flex items-center space-x-6 ml-auto">
                        <div className="flex items-center text-gray-700 bg-gray-100 px-4 py-2 rounded-full border border-gray-200">
