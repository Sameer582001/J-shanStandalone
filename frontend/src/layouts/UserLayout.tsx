...
import { LayoutDashboard, LogOut, User, Wallet, ShoppingCart, Layers } from 'lucide-react';
...
const UserLayout: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex">
            {/* Sidebar */}
            <aside className="w-64 bg-white shadow-xl hidden md:block z-10">
                <div className="p-6 border-b border-gray-100">
                    <h1 className="text-2xl font-bold bg-gradient-to-r from-indigo-600 to-purple-600 bg-clip-text text-transparent">MLM System</h1>
                    <p className="text-xs text-gray-400 mt-1 uppercase tracking-wider">Master Account</p>
                </div>
                <nav className="mt-6 px-4 space-y-2">
                    <Link
                        to="/dashboard"
                        className="flex items-center px-4 py-3 text-gray-600 hover:bg-indigo-50 hover:text-indigo-600 rounded-xl transition-all font-medium"
                    >
            ...
            <div className="flex-1 flex flex-col">
                ...
                <header className="bg-white shadow-sm h-16 flex items-center justify-between px-8 border-b border-gray-100">
                    ...
                    <div className="flex items-center space-x-6 ml-auto">
                        <div className="flex items-center text-gray-700 bg-gray-50 px-3 py-1.5 rounded-full border border-gray-200">
